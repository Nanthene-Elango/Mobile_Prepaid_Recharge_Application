...
function displayPlans(plans) {
    ...
    plans.forEach((plan) => {
        tableBody.innerHTML += `
                    <tr>
                        <td><input type="checkbox" class="plans-checkbox" onclick="updateDeleteButton()" data-index="${plan.planid}"></td>
                        <td>${plan.planid}</td>
                        <td>${plan.category}</td>
                        <td>${plan.price}</td>
                        <td>${plan.data}</td>
...
function toggleSelectAll() {
    const checkboxes = document.querySelectorAll(".plans-checkbox");
